...
interface Props {
  ...
  scrollRef: React.RefObject<HTMLDivElement | null> // kontener scrolla (vimowy scroll w ViewerPane)
  innerRef: React.RefObject<HTMLDivElement | null> // wewnętrzna treść (zaznaczanie/karetka w trybie copy)
}
