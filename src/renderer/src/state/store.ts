...
/**
 * Czy nad siatką paneli jest otwarty jakikolwiek element interfejsu.
 *
 * W Electronie panele przeglądarki były zwykłymi elementami DOM, więc z-index załatwiał
 * sprawę. W Tauri to natywne webview-dzieci okna, leżące ZAWSZE nad webview interfejsu —
 * modal ustawień, notatki czy pasek find zostałyby przykryte stroną internetową.
